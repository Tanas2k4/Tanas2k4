...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=16&pause=2000&color=FF69B4&vCenter=true&width=900&lines=I+build+backend+systems%2C+APIs%2C+and+occasionally+dip+into+frontend+with+modern+tools.)](https://tanas2k4.github.io/Portfolio/)

My current tech stack includes .NET Core, Spring Boot, Java, Ruby, JavaScript, TypeScript, React, and Tailwind CSS.
